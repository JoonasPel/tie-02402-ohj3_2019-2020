...
QT_MOC_LITERAL(5, 49, 21), // "on_buttonBox_rejected"
QT_MOC_LITERAL(6, 71, 32) // "on_horizontalSlider_valueChanged"

    },
    "Dialog\0valueChanged\0\0value\0"
...
void Dialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Dialog::valueChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Dialog::valueChanged(int _t1)
{
